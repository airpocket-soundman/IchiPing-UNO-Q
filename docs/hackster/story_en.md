...
3. Deploy the App Lab app from `uno_q/app/` and start the audio worker (`runtime-audio-worker.py --loop --excitation prbs16k --capture-format S32_LE --playback-rms 0.0088`).
4. Set all switches to CLOSE and press EXEC once to record the baseline.
