...
![Model apartment floor plan: rooms A, B, C, windows a, b, c and doors AB, BC](../img/house_en.png)
...
![UNO Ping wiring diagram](../img/unoq_wiring_en.svg)
...
Fabrication files: `board/Gerber_uno_q_shield_2026-09-13.zip` (UNO Q shield, Rev B) and `board/Gerber_analog_shield_2026-09-13.zip` (audio shield, Rev D), exported from EasyEDA Pro with Gerber and drill layers.
